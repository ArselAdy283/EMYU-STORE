...
<script>
    ...
    function gantiPasswordPopup() {
        fetch("ganti_password.php")
            .then(res => res.text())
            .then(html => {
                document.getElementById("gantiPasswordContent").innerHTML = html;
                document.getElementById("gantiPasswordPopup").classList.remove("hidden");
            });
    }
</script>
