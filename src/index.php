...
<body class="overflow-x-hidden overflow-y-scroll bg-gradient-to-tr from-[color:#ff392c] via-black to-[color:#ff392c] min-h-screen text-white">
    ...
    <section class="h-screen flex items-center justify-between px-12">
        ...
        <div class="flex flex-col items-center md:items-start translate-y-[-100px] md:w-1/3 md:translate-x-[-200px] md:translate-y-[-100px]">
            ...
            <button class="mt-20 md:translate-x-[180px] px-8 py-3 bg-red-500 rounded-full font-semibold text-white text-lg shadow-lg hover:bg-red-600 transition" onclick="window.location.href='topup.php'">
                Top Up
            </button>
        </div>
    </section>
