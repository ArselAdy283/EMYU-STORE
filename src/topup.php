...
<body class="overflow-x-hidden overflow-y-scroll min-h-screen bg-gradient-to-tr from-[#ff392c] via-black to-[#ff392c] font-sans text-white">
    ...
    <div class="flex flex-col items-center text-center space-y-12 translate-y-[50px]">
        <!-- Judul -->
        <h1 class="text-[50px] md:text-[70px] font-extrabold text-[color:#ffed00]">GAMES</h1>

        <!-- Card Games -->
        <div class="flex flex-col space-y-6 md:flex-row md:space-x-8">
            <!-- Card 1 -->
            <div class="bg-red-800/70 backdrop-blur-md rounded-2xl p-4 w-[250px] md:w-[160px] shadow-xl transform transition duration-300 hover:scale-110">
        ...
        <!-- Deskripsi -->
        <p class="hidden md:flex max-w-lg text-white">
